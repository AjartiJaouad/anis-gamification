        ...
        <div class="grid gap-8 lg:grid-cols-[260px_minmax(0,1fr)]">
            ...
            <div class="space-y-8">
                ...
                <header class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-on-surface-variant">Admin • Gestion des questions</p>
                        <h1 class="text-3xl font-headline font-extrabold text-on-surface">Questions QCM</h1>
                    </div>
                    <a href="{{ route('admin.questions.create') }}" class="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-3 text-sm font-semibold text-on-primary hover:bg-primary-dim transition">
                ...
                <div class="overflow-hidden rounded-3xl bg-white shadow-sm border border-surface-container">
                    <div class="px-6 py-5 border-b border-surface-container bg-surface-container-lowest">
                        <h2 class="text-lg font-semibold text-on-surface">Liste des questions</h2>
                        <p class="text-sm text-on-surface-variant mt-1">Voir toutes les questions avec le quiz et le niveau associés.</p>
                    </div>
                            ...
                            <tbody class="divide-y divide-surface-container-low bg-white">
                                @forelse($questions as $question)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-on-surface">{{ $question->level->name }}</td>
