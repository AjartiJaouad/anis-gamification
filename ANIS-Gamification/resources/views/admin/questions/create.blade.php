...
<head>
    ...
    <title>Admin - Ajouter une question</title>
            ...
            <div class="space-y-8">
                <header class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 class="text-3xl font-headline font-extrabold text-on-surface">Nouvelle question</h1>
                    </div>
                    ...
                    <form action="{{ route('admin.questions.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="question" name="question" rows="4" required
                                class="mt-2 w-full rounded-2xl border border-surface-container bg-white px-4 py-3 text-on-surface outline-none focus:border-primary focus:ring-2 focus:ring-primary/10">{{ old('question') }}</textarea>
                            @error('question')
                                <p class="mt-2 text-sm text-error">{{ $message }}</p>
                            @enderror
                        </div>
